module calc_NN
    !**************************************************
    !  SINGLE thread NN inference routine for LAMMPS
    !  L. Wang 2023.1 
    !**************************************************
    use mod_mpi
    ...
    subroutine cal_energy_force_NN(feat,dfeat,num_neigh,list_neigh,AL,xatom,natom_tmp,nfeat0_tmp,m_neigh_tmp)
        ...
        allocate(feat_type(nfeat1m,natom_tmp,ntype))
        ...
        allocate(energy_type(natom_tmp,ntype))
        allocate(dEdf_type(nfeat1m,natom_tmp,ntype))
